...
import 'package:bottom_navbar/screens/wishlist.dart';
...
class _Navbar_DemoState extends State<Navbar_Demo> {
  List<Widget> pages= [Homepage_screen(),Search_Screen(),Profile_Screen(),Wishlist_Screen()];
  int currentIndex=0;
  @override
    ...
    return Scaffold(
      ...
      BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.star_outline_sharp),
              label: "Wish List"
          ),
        ],
      ),
